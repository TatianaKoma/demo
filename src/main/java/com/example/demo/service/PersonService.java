...
public class PersonService implements ApplicationContextAware {
    ...
    public void callTransactionalMethodsWithoutTransaction() {
        LOGGER.info("================ callTransactionalMethodsWithoutTransaction() =====================");
        try {
            ...
            LOGGER.error("Error in callTransactionalMethodsWithoutTransaction() : {}", e.getClass());
        }
        required();
        requiresNew();
        mandatory();
    ...
    @Transactional
    public void callTransactionalMethodsWithTransaction() {
        LOGGER.info("================ callTransactionalMethodsWithTransaction() ========================");
        try {
            Person person1 = new Person();
            person1.setFirstName("Person1");
            person1.setLastName("Person1");
            ...
            LOGGER.error("Error in callTransactionalMethodsWithTransaction() : {}", e.getClass());
        }
        required();
        requiresNew();
        mandatory();
